...
Get-EventLog -LogName System -After (Get-Date).AddHours(-24) | Out-File -FilePath . (2)\last_24.txt"
...
Get-EventLog -LogName System -EntryType Error | Out-File -FilePath . (2)\errors.txt"
