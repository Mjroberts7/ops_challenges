...
# Script Name:                  ops401_challenge17.py
# Author:                       Michael Roberts 
# Date of latest revision:      01/30/2024
# Purpose:                      create a python script that can get file/string and compare it to output or get ssh client 
# Execution:			        have to run python3 ops401_challenge17.py
...
if __name__ == "__main__":
    ...
    while True:
        ...
        chk = int(input('option[1], option[2], or option[3]? '))
        if chk == int(1):
